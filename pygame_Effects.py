...
bulletSound = pygame.mixer.Sound("./assets/Game/bullet.mp3")
hitSound = pygame.mixer.Sound("./assets/Game/hit.mp3")
music = pygame.mixer.music.load("./assets/Game/music.mp3")
...
class player(object):
    ...
    def hit(self):
        ...
        i = 0                                           #delay display time of text
        while i < 100:
            pygame.time.delay(10)
            i += 1
            for event in pygame.event.get():            #still allow to exit the game during delay
